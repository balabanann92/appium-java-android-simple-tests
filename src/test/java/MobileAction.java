...
public class MobileAction {
    ...
    /**
     * Scroll down to the element using vertical screen swipe 100 times
     * @param element is element to scroll
     **/
    public void scrollDownToElement(MobileElement element) {
        scrollDownToElement(element, 100);
    }

    /**
     * Scroll down to the element using vertical screen swipe
     * @param element is element to scroll
     * @param maxRepeatCount indicates max times to vertical swipe
     **/
    public  void scrollDownToElement(MobileElement element, int maxRepeatCount) {
        int counter = 0;
